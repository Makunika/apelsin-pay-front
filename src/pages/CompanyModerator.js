              ...
              <Table>
                ...
                <TableBody>
                  {users
                    ...
                    .map((row) => {
                      const { id, userId, firstName, lastName, middleName, email, phone, birthday, passportSeries,
                        passportNumber } = row
                      ...
                      return (
                        <TableRow
                          ...
                          tabIndex={-1}
                        >
                          <TableCell align="left">{lastName} {firstName} {middleName}</TableCell>
                          <TableCell align="left">{email}</TableCell>
                          <TableCell align="left">{passportSeries} {passportNumber}</TableCell>
                          <TableCell align="left">{fDate(birthday)}</TableCell>
                          <TableCell align="left">{phone}</TableCell>
                          <TableCell align="left">
                            <Label
                              variant="ghost"
                              color={('ban' === 'banned' && 'error') || 'success'}
                            >
                              {sentenceCase('ban')}
                            </Label>
                          </TableCell>
