...
export const LOGIN_REDIRECT_URI = process.env.REACT_APP_LOGIN_REDIRECT_URI || "http://payment.graduate.pshiblo.xyz/login";

export const OAUTH_CLIENT_ID = "browser_payment";
export const OAUTH_SCOPE = "user_payment";
